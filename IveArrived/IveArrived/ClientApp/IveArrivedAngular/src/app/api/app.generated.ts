...
export class AccountService {
    ...
    updateSME(displayName: string | null | undefined, contactName: string | null | undefined, address: string | null | undefined, city: string | null | undefined, zipCode: string | null | undefined, phoneNumber: string | null | undefined, logo: FileParameter | null | undefined, flier: FileParameter | null | undefined): Observable<FileResponse | null> {
        let url_ = this.baseUrl + "/api/Account/UpdateSME";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateSME(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateSME(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse | null>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateSME(response: HttpResponseBase): Observable<FileResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CourierService {
    ...
    getSMEDataForModify(): Observable<GetProfileModel> {
        let url_ = this.baseUrl + "/api/Courier/GetSMEDataForModify";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetSMEDataForModify(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetSMEDataForModify(<any>response_);
                } catch (e) {
                    return <Observable<GetProfileModel>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetProfileModel>><any>_observableThrow(response_);
        }));
    }

    protected processGetSMEDataForModify(response: HttpResponseBase): Observable<GetProfileModel> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetProfileModel.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetProfileModel>(<any>null);
    }
}
...
export class GetProfileModel implements IGetProfileModel {
    displayName?: string | undefined;
    contactName?: string | undefined;
    address?: string | undefined;
    city?: string | undefined;
    ...
    flier?: string | undefined;

    constructor(data?: IGetProfileModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.flier = _data["flier"];
        }
    }

    static fromJS(data: any): GetProfileModel {
        data = typeof data === 'object' ? data : {};
        let result = new GetProfileModel();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["phoneNumber"] = this.phoneNumber;
        data["logo"] = this.logo;
        data["flier"] = this.flier;
        return data; 
    }
}

export interface IGetProfileModel {
    displayName?: string | undefined;
    contactName?: string | undefined;
    address?: string | undefined;
    city?: string | undefined;
